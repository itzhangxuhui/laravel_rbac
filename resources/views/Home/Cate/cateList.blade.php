...
<div class="qing tibg" style="margin-bottom: 25px;">
    <div class="juzhong">
        <div class="lf weiz"><a href="#">首页</a>
            <span> &gt; </span><a href="#">邮票</a>
            <span> &gt; </span><a href="#">小版邮票</a>
        </div>
    </div>
</div>
<!--页面标题 -->
<div class="qing juzhong">
    <div class="lf" style="width:224px;">
        <div class="cenav">
            <div class="ceti">邮票</div>
            <div class="cenak">
                <a href="#">生肖邮票<b>&gt;</b></a>
                <a href="#" class="ceann">小版邮票<b>&gt;</b></a>
                <a href="#">年册邮票<b>&gt;</b></a>
                <a href="#">纪特邮票<b>&gt;</b></a>
                <a href="#">J｜T邮票<b>&gt;</b></a>
                <a href="#">文革｜编号<b>&gt;</b></a>
        ...
        <div class="qing tubg">
            ...
            <div>
                <dl class="dhlb">
                    <dd>
                        <a href="#" class="jftu"><img src="{{asset('Home/images/4054672598.jpg')}}" width="176" height="176" data-bd-imgshare-binded="1"></a>
                        <div class="qing jfm">
                            <a href="#">2017中国丁酉（鸡）年金银纪念币3...</a>
                        </div>
                        <div>
                            <div class="jiag">￥680.00</div>
                            <a href="#" class="mai"><span>立即购买</span><span>立即购买</span></a>
                        </div>
                    </dd>
    ...
    <div class="rf" style="width:955px;">
        <div class="lex">
            <div class="lex-ti">小版邮票</div>
            <div class="leix">
                <div class="lf">类 型</div>
                <div class="leixa">
                    {{--<a href="{{url("Home/Cate/cateList/$id")}}?price={{$price}}&addr=0" class="leinn">不限</a>--}}
                    <a href='{{url("Home/Cate/cateList/$id")}}?k=0_{{$price}}'>不限</a>
                    <a href='{{url("Home/Cate/cateList/$id")}}?k=1_{{$price}}'>中国</a>
                    <a href='{{url("Home/Cate/cateList/$id")}}?k=2_{{$price}}'>朝鲜</a>
                    <a href='{{url("Home/Cate/cateList/$id")}}?k=3_{{$price}}'>俄罗斯</a>
                    {{--<a href="{{url("Home/Cate/cateList/$id")}}?price={{$price}}&addr=1">中国</a>--}}
                    {{--<a href="{{url("Home/Cate/cateList/$id")}}?price={{$price}}&addr=2">朝鲜</a>--}}
                    {{--<a href="{{url("Home/Cate/cateList/$id")}}?price={{$price}}&addr=3">俄罗斯</a>--}}

                </div>
            </div>

            <div class="leix" id="le">
                <div class="lf">价 格</div>
                <div class="my_lf">
                    <a href="{{url("Home/Cate/cateList/$id")}}?k={{$addr}}_0">不限</a>
                    <a href="{{url("Home/Cate/cateList/$id")}}?k={{$addr}}_1">0-100</a>
                    <a href="{{url("Home/Cate/cateList/$id")}}?k={{$addr}}_2">100-200</a>
                    <a href="{{url("Home/Cate/cateList/$id")}}?k={{$addr}}_3">200-300</a>
                    <a href="{{url("Home/Cate/cateList/$id")}}?k={{$addr}}_4">300-400</a>
                    <a href="{{url("Home/Cate/cateList/$id")}}?k={{$addr}}_5">400-500</a>
                    <a href="{{url("Home/Cate/cateList/$id")}}?k={{$addr}}_6">500以上</a>
                </div>

          {{--      <a href="{{url("Home/Cate/cateList/$id")}}?addr={{$addr}}&price=1">0-100</a>
                <a href="{{url("Home/Cate/cateList/$id")}}?addr={{$addr}}&price=2">100-200</a>
                <a href="{{url("Home/Cate/cateList/$id")}}?addr={{$addr}}&price=3">200-300</a>
                <a href="{{url("Home/Cate/cateList/$id")}}?addr={{$addr}}&price=4">300-400</a>
                <a href="{{url("Home/Cate/cateList/$id")}}?addr={{$addr}}&price=5">400-500</a>
                <a href="{{url("Home/Cate/cateList/$id")}}?addr={{$addr}}&price=6">500以上</a>--}}
            </div>
        </div>
        <script>
            $('.leixa>a').eq({{$addr}}).addClass('sel');
            $('.my_lf>a').eq({{$price}}).addClass('sel');
        </script>
        <div class="shai">
            <a href="#"><span>默认</span><b></b></a>
            <a href="#"><span>价格</span><b></b></a>
            <a href="#"><span>新品</span><b></b></a>
        </div>
        <dl class="yplb">
            @forelse($goods_list as $v)
            <dd> <a href='{{url('Home/Goods/detail')}}?id={{$v->id}}' class="yptu"><img src='{{asset("/upload/$v->goods_pic")}}' width="209" height="209"></a>
                <div class="ypmc"> <a href="#">{{$v->goods_name}}</a> </div>
                <div>
                    <div class="jiag">￥{{$v->goods_price}}</div>
                    <a href="#" class="mai"><span>立即购买</span><span>立即购买</span></a> </div>
            </dd>
                @empty
                没有数据
            @endforelse
        ...
        <div class="qing yema" style="margin-top:36px;">
            <table border="0" cellspacing="0" cellpadding="0">
                <tbody><tr>
                    <td>
                        <a href="#"  onclick="nextPage('start')" class="syee">首页</a>
                        <a href="#" class="sye" onclick="nextPage('prev')"></a>

                        <a href="javascript:void(0)" onclick="nextPage('next')" class="xye"></a>
                        <a href="javascript:void(0)" onclick="nextPage('end')" class="xyee">尾页</a>
                        <input type="text" value="1" id="curent_page">
...
<script>
    ...
    function nextPage(flag){
        var id = '{{$id}}';
        var page = parseInt($('#curent_page').val());
        ...
        $.post("{{url('Home/Cate/ajaxPageData')}}",{id:id,page:page},function(data){
            for(var i in data){
                str +="<dd>";
                str +="<a href='{{url('Home/Goods/detail')}}?id="+data[i].id+"' class=\"yptu\">";
                str +="<img src='{{asset("/upload")}}/"+data[i].goods_pic+"' width=\"209\" height=\"209\"></a>";
                str += "<div class=\"ypmc\"> <a href=\"#\">"+data[i].goods_name+"</a> </div>";
                str += "  <div>\n" +
                    "                    <div class=\"jiag\">￥"+data[i].goods_price+"</div>\n" +
                    "                    <a href=\"#\" class=\"mai\"><span>立即购买</span><span>立即购买</span></a> </div>";
                str +="</dd>";
            }
